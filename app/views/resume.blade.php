...
<body>
    ...
    <!--SUMMARY STATEMENT -->
    <section id="summary" name="summary"></section>
    <div id="intro">
        <div class="container">
            <div class="row">
    ...
    <div class="container desc">
        <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <p>
                        Responsibilities involve focusing on design, quality, and functionality. Deliver websites that accurately match the design files provided by design team. Ensure all work is thoroughly tested before presented to the customer. Adhere to the quality standards and principles developed by AM Design. Take the time to improve skills and continue to learn. Present alternatives for any limitations of the medium. Work with the team on web projects to develop cross-platform websites and applications, including mobile solutions. Maintain the support of our active sites in bug fixes and any other issues that arise. Assist in social media/online strategy sessions Track development time in relation to project scope. Reports to the lead developer. Proficient in PHP, HTML, CSS, JavaScript, JQuery. Familiar with the Adobe Suite (Photoshop, Illustrator, Etc). Must be able to develop sites from technical specifications & graphical representations.
                    </p>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <p><more>Platform/Environment: Hypertext Markup Language (HTML), Linux, Mac OSX, VirtualBox, Vagrant, Ansible, Apache, mySQL, PHP, Git, GitHub, JavaScript, jQuery, Cascading Style Sheets (CSS), Bootstrap framework, WordPress Content Management System (CMS), Adobe Photoshop, Adobe Illustrator, and Adobe Premiere Pro.</more></p>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <p><t>IT Project Manager</t><br/>
                        Operations Training Support, G6, AMEDDC&S
                    </p>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <p><t>IT Specialist</t><br/>
                        Operations Support, G6, AMEDDC&S
                    </p>
                    <p>Coordinates deployment services provided by the local Network Enterprise Center (NEC) to AMEDDC&S functional users. Manages AMEDDC&S involvement in the initial deployment, subsequent movement, and technology refresh of computer equipment, printers, copiers, and telephones</p>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <p>Responsible for the daily operations of the Information Management Office as resident technical expert on all ADPE (Automated Data Processing Equipment), communications products, and audio / visual equipment, and networks assigned to the DMRTI command spanning four buildings and two installations (Ft. Sam Houston and Camp Bullis) in a senior joint military environment.</p>
                </div>
                <div class="col-lg-3">
    ...
    <div class="container desc">
        <div class="row">
                ...
                <div class="col-lg-6">
                    <p><t>CodeUp</t><br/>
                        Geekdom <br/>
                        <i>Web Development using the LAMP stack</i>
                    </p>
                </div>
                <div class="col-lg-3">
                    <p><sm>2014</sm></p>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <p><t>Computer Science</t><br/>
                        Regis University <br/>
                        <i>4 CS Leveling Courses</i>
                    </p>
                </div>
                <div class="col-lg-3">
                    <p><sm>2012-2013</sm>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <p><t>A.A.S., Computer Information Systems</t><br/>
    ...
    <section id="certs" name="certifications"></section>
    <div class="container desc">
        <div class="row">
                <div class="col-lg-2 col-lg-offset-1">
                ...
                <div class="col-lg-6">
                    <p><t>Project + Certified Professional</t><br/>
                        CompTIA
                    </p>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <p><t>Security + Certified Professional</t><br/>
                        CompTIA
                    </p>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <p><t>A + Certified Computer Technician</t><br/>
                        CompTIA
                    </p>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <p><t>Cisco Certified Network Associate</t><br/>
                        Cisco
                    </p>
                </div>
                <div class="col-lg-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <h5>SOCIAL LINKS</h5>
                    <p>
                        <a href="https://twitter.com/fpigeonjr" target="_blank"><i class="fa fa-twitter fa-2x"></i></a>
                        <a href="https://github.com/fpigeon" target="_blank"><i class="fa fa-github fa-2x"></i></a>
                        <a href="https://www.linkedin.com/in/frankpigeonjr" target="_blank"><i class="fa fa-linkedin fa-2x"></i></a>
                        <a href="mailto:frank.pigeonjr@gmail.com" target="_blank"><i class="fa fa-envelope fa-2x"></i></a>
                    </p>
                </div>
            </div><!--/.row -->
        </div><!--/.container -->
